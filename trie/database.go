...
import (
	...
	"github.com/tpkeeper/evm/metrics"
...
type Database struct {
	diskdb keyvaluedb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb keyvaluedb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb keyvaluedb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() keyvaluedb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) Cap(limit common.StorageSize) error {
	...
	if flushPreimages {
		for hash, preimage := range db.preimages {
			...
			if batch.ValueSize() > keyvaluedb.IdealBatchSize {
...
func (db *Database) commit(hash common.Hash, batch keyvaluedb.Batch, uncacher *cleaner) error {
