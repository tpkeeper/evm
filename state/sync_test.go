...
// account array.
func checkStateAccounts(t *testing.T, db keyvaluedb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db keyvaluedb.Database, root common.Hash) error {
...
func checkStateConsistency(db keyvaluedb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(keyvaluedb.Database), srcRoot)
